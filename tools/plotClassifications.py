...
def plot_stacked_bar_chart(classification_counts, group_size, data_set_choice):
    ...
    ax.set_xlabel(f'{data_set_choice.title()} Groups (per {group_size})')
    ax.set_ylabel('Number of SATDs')
    ax.set_title(f'Number of SATDs per Classification Type per {group_size} {data_set_choice.title()}')
...
plot_stacked_bar_chart(classification_counts, group_size, data_set_choice)
